...
class PhotoCrop:
    ...
    def get_correct_crop(self):
        ...
        if 0 < self.tr < self.tr2 or self.tr > self.tr2 == 0:
            if self.tr < 3.2:
    ...
    def get_photo_corners(self):
        ...
        max_y = np.max([i['y'] + i['h'] for i in boxes]) if len(boxes) > 0 else 0
    ...
    def get_photo_corners2(self):
        ...
        for line in boxes:
            if line['word'].lower() == 'state':
                try:
                    right_top_crop, right_top_x, right_top_y = Helper.crop_from_point(img_cropped,
                                                                                      (line['x'], line['y']),
                                                                                      0.40,
                                                                                      0.05,
                                                                                      0.30, 0.1)
